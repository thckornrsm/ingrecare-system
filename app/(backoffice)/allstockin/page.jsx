                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-[#3FA170] bg-white
                            ...
                            <option value="" disabled hidden className="text-gray-400">เช่น กิโลกรัม, แพ็ค, ขวด</option>
                    ...
                    <div>
                        ...
                        className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-[#3FA170] bg-white
                            ...
                            <option value="" disabled hidden className="text-gray-400">เช่น วัน, สัปดาห์, เดือน, ปี</option>
