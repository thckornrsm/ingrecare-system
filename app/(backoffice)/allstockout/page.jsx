...
export default function AllStockout() {
    ...
    const categories = ["ทั้งหมด", ...new Set(stockoutHistory.map(item => item.category_id))];
    const unitsForDropdown = [...new Set(stockoutHistory.map(item => item.unit_type))].sort();
                ...
                <main className="flex-1 overflow-y-auto py-9 px-10 sm:px-14 md:px-25">
                    <div className="max-w-7xl mx-auto">
                        <div className="mb-8">
                            ...
                            <p className="text-[#979999]">ตารางข้อมูลเกี่ยวกับการเบิกจ่ายวัตถุดิบทั้งหมดในระบบ</p>
                        </div>
                                        ...
                                        {isLoading ? (
                                            ...
                                            sortedAndPaginatedIngredients.map((ingredient) => (
                                                <tr key={ingredient.id} className="bg-white border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td className="py-3 px-4">{ingredient.out_datetime}</td>
